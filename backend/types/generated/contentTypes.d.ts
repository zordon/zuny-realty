...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Property category (Apartment, House, Lot, etc.)';
...
export interface ApiFeatureFeature extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A feature such as WiFi, Gym, Swimming Pool, etc.';
    displayName: 'Feature';
    pluralName: 'features';
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<['USD', 'PAB']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    propertyType: Schema.Attribute.Enumeration<['sale', 'rent']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
